 ...
 */
mcpwm::mcpwm(PinName pin,mcpwm_unit_t mcpwm_num, mcpwm_io_signals_t io_signal):MCPWM_NUM(mcpwm_num),IO_SIGNAL(io_signal){
    ...
    mcpwm_init(MCPWM_NUM, MCPWM_TIMER_0, &pwmconfig);
    mcpwm_set_frequency(MCPWM_NUM, MCPWM_TIMER_0, 10000);
}

void mcpwm::write(int duty){
    mcpwm_set_duty(MCPWM_NUM, MCPWM_TIMER_0, MCPWM_OPR_A, duty);
}